...
describe('modelleertaal.js - Modelleertaal Parser generated by Jison', function(){
    ...
    it('parses identifiers with unicode', function() {
        assert.equal(parser.parse('σ=4.2')[0].right.value,'4.2');
        assert.equal(parser.parse('σπ=8.0')[0].right.value,'8.0');
        assert.equal(parser.parse('foo_σ_bεr=3.14')[0].right.value,'3.14');
    })
