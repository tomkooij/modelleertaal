// Modelleertaal mode for CodeMirror syntax highlighting
// based on pascal mode.
...
CodeMirror.defineMode("modelleertaal", function() {
  function words(str) {
...
CodeMirror.defineMIME("text/modelleertaal", "modelleertaal");
});
